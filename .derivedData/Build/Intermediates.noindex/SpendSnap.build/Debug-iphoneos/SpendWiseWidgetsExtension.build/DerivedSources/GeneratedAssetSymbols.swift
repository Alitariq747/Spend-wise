...
extension DeveloperToolsSupport.ImageResource {
    ...
    static let widgetBackgroundimage = DeveloperToolsSupport.ImageResource(name: "WidgetBackgroundimage", bundle: resourceBundle)
...
extension AppKit.NSImage {
    ...
    /// The "WidgetBackgroundimage" asset catalog image.
    static var widgetBackgroundimage: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .widgetBackgroundimage)
#else
        .init()
#endif
    }
...
extension UIKit.UIImage {
    ...
    /// The "WidgetBackgroundimage" asset catalog image.
    static var widgetBackgroundimage: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: .widgetBackgroundimage)
#else
        .init()
